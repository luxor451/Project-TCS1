...
mod test {
    ...
    fn test_prim_naif() {
        ...
        // map 42
        let path_to_test_map_42 = "./data/map_10_8_42.txt";
        let map_42 = load_map(path_to_test_map_42.to_string());
        // map 76
        assert_eq!(prim_naive_function(&map_42).1, -762);
        let path_to_test_map_76 = "./data/map_10_8_76.txt";
        let map_76 = load_map(path_to_test_map_76.to_string());
        assert_eq!(prim_naive_function(&map_76).1, -695);
        // map 1024
        let path_to_test_map_1024 = "./data/map_10_8_1024.txt";
        let map_1024 = load_map(path_to_test_map_1024.to_string());
        assert_eq!(prim_naive_function(&map_1024).1, -742);
        // map 2048
        let path_to_test_map_2024 = "./data/map_10_8_2048.txt";
        let map_2024 = load_map(path_to_test_map_2024.to_string());
